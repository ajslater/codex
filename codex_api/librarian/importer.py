...
from codex_api.models import Credit
...
FS_STATIC_PREFIX = Path("config") / STATIC_ROOT
...
class Importer:
    ...
    FIELD_PREFIX_LEN = len("codex_api.Comic.")
    ...
    def get_or_create_simple_model(name, cls):
        ...
        defaults = {}
        defaults["name"] = name
        inst, created = cls.objects.get_or_create(
    ...
    def import_metadata(self):
        ...
        try:
            ...
            library = Library.objects.get(pk=self.library_id)
            self.set_locales()
