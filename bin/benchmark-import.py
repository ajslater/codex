...
Usage:
    uv run python bin/benchmark-import.py --count 1000
    uv run python bin/benchmark-import.py --scenarios reimport --json out.json
"""
...
def _generate_library(comics_dir: Path, count: int, seed: int, *, regen: bool) -> None:
    ...
    from mock_comics.mock_comics import create_file
