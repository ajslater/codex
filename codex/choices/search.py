...
FIELDMAP = MappingProxyType(
    {
        "metron_age_rating": _get_fieldmap_values(
            "age", "age_rating", "metron_age_rating"
        ),
        "tagged_age_rating": (),
        ...
        "language": ("lang"),
        "main_character": _get_fieldmap_values("main_character"),
        "main_team": _get_fieldmap_values("main_team"),
        "month": (),
        "monochrome": _get_fieldmap_values("black_and_white"),
        "name": ("title",),
        "notes": (),
        "original_format": ("format",),
        "protagonist": ("protag", "lead"),
        "publisher": (),
        "page_count": ("pages",),
