...
from codex.librarian.importer.importer.query.update_fks import QueryIsUpdateImporter
...
class QueryForeignKeysQueryImporter(QueryIsUpdateImporter):
    ...
    def _set_fk_totals(self, fk_key: str, status_type: ImportStatusTypes):
        total_fks = 0
    ...
    def query_all_missing_models(self):
        ...
        try:
            ...
            self._set_fk_totals(CREATE_FKS, ImportStatusTypes.CREATE_TAGS)
            self._set_fk_totals(UPDATE_FKS, ImportStatusTypes.UPDATE_TAGS)
        finally:
