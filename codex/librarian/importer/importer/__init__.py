...
from codex.librarian.importer.importer.moved import MovedImporter
...
class ComicImporter(MovedImporter):
    ...
    def apply(self):
        ...
        try:
            ...
            self.changed += timestamp_updater.update_all_groups(
                deleted_comic_groups, self.start_time, self.library
            )
        finally:
