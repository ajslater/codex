...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='folder',
            name='first_comic',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='+', to='codex.comic'),
        ),
        migrations.AddField(
            model_name='folder',
            name='sort_name',
        ...
        migrations.AlterField(
            ...
            name='key',
            field=models.CharField(choices=[('FV', 'Folder View'), ('RG', 'Registration'), ('NU', 'Non Users'), ('AU', 'Auto Update'), ('SO', 'Search Index Optimize'), ('IM', 'Import Metadata')], db_index=True, max_length=2),
        ),
        migrations.AlterField(
            model_name='librarianstatus',
            name='status_type',
            field=models.CharField(choices=[('CCC', 'Create Covers'), ('CCD', 'Purge Covers'), ('CFO', 'Find Orphan'), ('IDM', 'Dirs Moved'), ('IFM', 'Files Moved'), ('ITR', 'Aggregate Tags'), ('ITQ', 'Query Missing Fks'), ('ITC', 'Create Fks'), ('IDU', 'Dirs Modified'), ('IFU', 'Files Modified'), ('IFC', 'Files Created'), ('IMQ', 'Query M2M Fields'), ('IMC', 'Link M2M Fields'), ('IDD', 'Dirs Deleted'), ('IFD', 'Files Deleted'), ('IFI', 'Failed Imports'), ('ICQ', 'Query Missing Covers'), ('ICM', 'Covers Moved'), ('ICU', 'Covers Modified'), ('ICC', 'Covers Created'), ('ICD', 'Covers Deleted'), ('ICL', 'Covers Link'), ('IGU', 'Group Update'), ('JTD', 'Cleanup Fk'), ('JCU', 'Codex Update'), ('JCR', 'Codex Restart'), ('JCS', 'Codex Stop'), ('JDO', 'Db Optimize'), ('JDB', 'Db Backup'), ('JSD', 'Cleanup Sessions'), ('JCD', 'Cleanup Covers'), ('SIX', 'Search Index Clear'), ('SIU', 'Search Index Update'), ('SID', 'Search Index Remove'), ('SIM', 'Search Index Merge'), ('WPO', 'Poll')], db_index=True, max_length=3),
        ),
        migrations.AlterField(
            model_name='timestamp',
            name='key',
            field=models.CharField(choices=[('JA', 'Janitor'), ('VR', 'Codex Version'), ('SI', 'Search Index UUID'), ('AP', 'API Key')], db_index=True, max_length=2),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.CharField(choices=[('p', 'P'), ('i', 'I'), ('s', 'S'), ('a', 'A'), ('f', 'F')], db_index=True, max_length=1)),
                ('sort_name', models.CharField(db_index=True, default='', max_length=128)),
        ...
        migrations.AddField(
            model_name='folder',
            name='custom_cover',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='codex.customcover'),
        ),
        migrations.AddField(
            model_name='imprint',
            name='custom_cover',
