# Generated by Django 3.1 on 2020-08-21 18:40
...
class Migration(migrations.Migration):
    ...
    replaces = [('codex', '0001_initial'), ('codex', '0002_auto_20200707_2353'), ('codex', '0003_auto_20200729_0003'), ('codex', '0004_auto_20200729_0008')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('path', models.CharField(db_index=True, max_length=128, unique=True, validators=[codex.models.validate_dir_exists])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imprint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.imprint')),
                ('publisher', models.ForeignKey(on_delete=codex.models.Publisher.get_default_publisher, to='codex.publisher')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imprint', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.imprint')),
                ('publisher', models.ForeignKey(on_delete=codex.models.Publisher.get_default_publisher, to='codex.publisher')),
                ('series', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.series')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('name', models.CharField(db_index=True, max_length=32)),
                ('path', models.CharField(db_index=True, max_length=128, validators=[codex.models.validate_dir_exists])),
                ('sort_name', models.CharField(max_length=32)),
                ('library', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.library')),
                ('parent_folder', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='codex.folder')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.creditperson')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.creditrole')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue', models.DecimalField(db_index=True, decimal_places=2, default=0.0, max_digits=6)),
                ...
                ('critical_rating', models.CharField(db_index=True, max_length=32, null=True)),
                ('maturity_rating', models.CharField(db_index=True, max_length=32, null=True)),
                ('user_rating', models.CharField(db_index=True, max_length=32, null=True)),
                ...
                ('page_count', models.PositiveSmallIntegerField(db_index=True, default=0)),
                ...
                ('myself', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comic', to='codex.comic')),
                ('parent_folder', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comic_in', to='codex.folder')),
                ('publisher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.publisher')),
                ('series', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.series')),
                ...
                ('volume', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='codex.volume')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('bookmark', models.PositiveSmallIntegerField(db_index=True, null=True)),
                ('finished', models.BooleanField(db_index=True, default=False)),
                ('fit_to', models.CharField(default=None, max_length=6, null=True, validators=[codex.models.validate_fit_to_choice])),
